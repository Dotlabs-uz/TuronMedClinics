const uz = {
   ...
   promo: {
      title: "O'yinni o'zgartiruvchi tibbiy sayt.",
      text: "Biz bemorlarimizga eng yaxshi mahsulotlarni taqdim etish uchun bozorda faqat eng sifatli materiallardan foydalanamiz.",
      button: "Batafsil",
   },
   footer: {
